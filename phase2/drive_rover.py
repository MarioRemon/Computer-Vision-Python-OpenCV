...
class RoverState():
    def __init__(self):
        ...
        self.throttle_set = 0.6# 0.2 # Throttle setting when accelerating
        self.brake_set = 50 # Brake setting when braking
        ...
        self.error_limit = 110
        self.start_pos = None      # To store the initial position of the rover
        self.visited_pos = []   # To store the all the visited position by the rover
        self.waitingAtStartPos = 0
